...
import { Plus, Droplets, Lightbulb, Globe, Phone, FolderCode, Database, CircleHelp, Trash, Pencil, MoreVertical, CircleCheckBig, Search } from 'lucide-react';
  ...
  return (
    <div className='w-1/2 p-5 bg-white dark:bg-neutral-950 border rounded-xl border-sidebar-border/70 dark:border-sidebar-border min-h-[300px] max-h-[750px] flex flex-col'>
      ...
      <div className="relative mb-4 flex-shrink-0">
        ...
        <input
          type="text"
          placeholder="Buscar pagos por nombre..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
        />
      </div>
      ...
      <div className="flex flex-col space-y-4 overflow-y-auto max-h-[750px]">
        {pagosFiltrados.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <p className="text-sm">
              {searchTerm ? `No hay pagos que coincidan con "${searchTerm}"` : 'No hay pagos registrados'}
            </p>
          </div>
        )}
      </div>
